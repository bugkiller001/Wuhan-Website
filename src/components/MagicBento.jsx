...
const DEFAULT_GLOW_COLOR = '184, 149, 106';
...
const GlobalSpotlight = ({
  ...
  }, [containerRef, disableAnimations, enabled, spotlightRadius, glowColor, cardSelector]);
    ...
    <>
      ...
      <div className="card-grid bento-section" ref={gridRef}>
        {cardData.map((card, index) => {
          const baseClassName = `magic-bento-card ${textAutoHide ? 'magic-bento-card--text-autohide' : ''} ${enableBorderGlow ? 'magic-bento-card--border-glow magic-glow-card' : ''}`;
          const cardProps = {
...
export { GlobalSpotlight, ParticleCard };
